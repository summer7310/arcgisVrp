...
define("esri/dijit/Form","require dojo/_base/declare dojo/_base/lang dojo/has esri/kernel dojo/_base/array dojo/dom-style dojo/dom-construct dojo/dom-class dojo/query dijit/_Widget dijit/_TemplatedMixin dojo/text!esri/dijit/templates/Form.html".split(" "),function(q,e,m,r,s,h,t,n,p,k,u,v,w){e=e([u,v],{declaredClass:"esri.dijit.Form",widgetsInTemplate:!0,templateString:w,widgets:{},fieldTypes:{string:{widget:"dijit/form/TextBox"},date:{widget:"dijit/form/DateTextBox"},number:{widget:"dijit/form/NumberTextBox"},
...
(b=this.widgets[a],b.destroy());this.widgets=null},addField:function(a){var b,c,e,h,f,d=this;b=(a.template||this.fieldTemplate).replace("{label}",'\x3cspan class\x3d"esriFormFieldLabel"\x3e'+(a.label||a.name)+"\x3c/span\x3e");b=b.replace("{widget}",'\x3cdiv class\x3d"esriFormFieldWidget"\x3e\x3c/div\x3e');c=n.toDom(b);p.add(c,"esriFormField");e=k(".esriFormFieldWidget",c)[0];t.set(c,{display:!1===a.visible?"none":"block"});q([a.widget||this.fieldTypes[a.type].widget],function(b){h=a.widgetParameters||
d.fieldTypes[a.type].widgetParameters||{};f=new b(h,e);f.startup();p.add(f.domNode,"esriFormFieldWidget");f.fieldNode=c;f.initialState={value:a.value||null,visible:a.visible||!0,disabled:a.disabled||!1};d.domNode.appendChild(c);d.widgets[a.name]=f;d.setField(a);f.on("change",m.hitch(d,function(a,b){var c;b&&(c=b.value||b,b.target&&b.target.value&&(c=b.target.value),c={fieldName:a,value:c},d.emit("value-change",c))},a.name));d._fieldsLength--;var g,l;if(0===d._fieldsLength){b=k(".esriFormField",d.domNode);
for(g=0;g<b.length;g++)for(l=g;l<b.length;l++)(d.fields[g].label||d.fields[g].name)===k(".esriFormFieldLabel",b[l])[0].innerHTML&&n.place(b[l],d.domNode,g)}})},removeField:function(a){m.isString(a)||(a=a.name);a=this.getWidget(a);a.fieldNode.parentNode.removeChild(a.fieldNode);a.destroy()},getWidget:function(a){return this.widgets[a]},reset:function(){var a,b;for(a in this.widgets)this.widgets.hasOwnProperty(a)&&(b=this.widgets[a].initialState,this.setField({name:a,value:b.value,visible:b.visible,
